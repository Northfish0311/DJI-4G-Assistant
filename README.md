...
- **网络面板**：Windows 网卡状态、IPv4、网关、链路速率和本次运行的收发流量。
...
It includes diagnostics, Windows network status, multi-profile eSIM management, UCS2/PDU SMS, OTP extraction, USSD, guarded AT tools, verified USB mode switching, original `2CA3:4006` setup, and read-only rescue diagnostics. Provider data allowance requires a provider API.
